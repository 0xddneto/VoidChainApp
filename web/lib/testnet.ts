...
export const ABI = {
  ...
  dao: [
    ...
    { type: 'function', name: 'PROPOSAL_THRESHOLD_BPS', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint256' }] },
    { type: 'function', name: 'proposals', stateMutability: 'view', inputs: [{ type: 'uint256' }], outputs: [
      { name: 'ceilingUsd', type: 'uint256' }, { name: 'supplyAtStart', type: 'uint256' },
      { name: 'deadline', type: 'uint256' }, { name: 'forVotes', type: 'uint256' },
      { name: 'againstVotes', type: 'uint256' }, { name: 'executed', type: 'bool' },
    ] },
    ...
    { type: 'function', name: 'lockedVotes', stateMutability: 'view', inputs: [{ type: 'uint256' }, { type: 'address' }], outputs: [{ type: 'uint256' }] },
    { type: 'function', name: 'propose', stateMutability: 'nonpayable', inputs: [{ type: 'uint256' }, { type: 'uint256' }], outputs: [{ type: 'uint256' }] },
    { type: 'function', name: 'castVote', stateMutability: 'nonpayable', inputs: [{ type: 'uint256' }, { type: 'bool' }, { type: 'uint256' }], outputs: [] },
    { type: 'function', name: 'execute', stateMutability: 'nonpayable', inputs: [{ type: 'uint256' }], outputs: [] },
    { type: 'function', name: 'withdrawVote', stateMutability: 'nonpayable', inputs: [{ type: 'uint256' }], outputs: [] },
  ],
  counter: [
