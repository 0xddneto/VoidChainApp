...
export default function MintPage() {
  ...
  return <>
    ...
    <main className={styles.wrap}>
      <div className={styles.hero}><div className={styles.testnet}>● Robinhood testnet · V11 genesis</div><h1>Mint a VOID Deed with ETH.</h1><p>Mint one Deed with ETH. Each new mint locks VOID/ETH liquidity and funds the Paymaster. Apps and NFT trades use VOID.</p><a href="/market">Trade NFTs ↔ VOID →</a></div>
      ...
      <div className={styles.note}><p><strong>Testnet only.</strong> V11 preserves the block-pinned Deed ownership and exact 1,000,000,000 VOID ledger from the preceding testnet deployment. It does not duplicate supply or charge existing holders again.</p><p>The NFT/VOID pool runs inside Chain #1. Buy random: 1.5%. Buy selected: 2.5%. Sell: 1.5%. These totals include the 0.5% protocol fee. NFTs can be bought and sold repeatedly; their 500,000 VOID backing is released only once.</p></div>
    </main>
  </>;
}
