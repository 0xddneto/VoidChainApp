  ...
  return <>
    ...
    <main className={styles.wrap}>
      ...
      <article className={styles.docs}>
        ...
        <section id="status"><h2>Safety status</h2><p>This is pre-audit testnet software. V8 freezes the runtime oracle after initial configuration and places Paymaster and Treasury administration behind a public 48-hour timelock. Local tests, verified bytecode and live acceptance transactions are engineering evidence, not a third-party security audit or a mainnet-readiness statement. Testnet VOID has no monetary value. Production still requires an external audit, a hardware-backed multisig proposer, dedicated RPC infrastructure, incident procedures and a fresh deployment review.</p></section>
      </article>
    </main>
  </>;
}
