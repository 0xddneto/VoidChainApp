  ...
  return <>
    ...
    <main className={styles.wrap}>
      ...
      <article className={styles.docs}>
        ...
        <section id="status"><h2>Safety status</h2><p>This is pre-audit testnet software. Local tests, verified bytecode and live acceptance transactions are engineering evidence, not a third-party security audit or a mainnet-readiness statement. Testnet VOID has no monetary value. Production requires an external audit, multisig governance, dedicated RPC infrastructure, incident procedures and a fresh deployment review.</p></section>
      </article>
    </main>
  </>;
}
