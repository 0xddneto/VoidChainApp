...
const marketAbi = parseAbi(['function sellWithPermit(uint256,uint256,bytes)','function inventoryCount() view returns(uint256)']);
...
const appData = encodeFunctionData({ abi: marketAbi, functionName: 'sellWithPermit', args: [deedId, deadline, deedSignature] });
